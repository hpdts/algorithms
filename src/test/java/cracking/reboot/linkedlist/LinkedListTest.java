...
public class LinkedListTest {
	...
	public void intersection(){
		...
		Node date2 = new Node(1);
		Node date3 = new Node(5);
		Node date4 = new Node(9);
		Node date5 = new Node(7);
		Node date6 = new Node(2);
		Node date7 = new Node(1);
		list1.next = date2;
		date2.next = date3;
		date3.next = date4;
		date4.next = date5;
		...
		Node result = linkedList.findIntersection(list1, list2);

		assertThat(result.label, is(7)); 
	}

	@Test
	public void begginingLoop(){
		...
		Node result = linkedList.findBeggining(node1);

		assertThat(result.label, is(4)); 
	}
}